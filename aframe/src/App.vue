<template>
  ...
  <a-scene>
    <a-assets>
      ...
      <img id="i1" src="./assets/1.png" />
      <img id="i2" src="./assets/2.png" />
      <img id="i3" src="./assets/3.png" />
      <img id="i4" src="./assets/4.png" />
    </a-assets>
    <a-entity
      id="camera"
      position="0 0 0"
...
export default {
  ...
  methods: {
    ...
    registerRaycast() {
      window.AFRAME.registerComponent("raycaster-listen", {
        init: function () {
